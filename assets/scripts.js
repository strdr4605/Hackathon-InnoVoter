function progress(beginningTime, endingTime, curentTime, $element) {
  ...
  $element.find('div').animate({ width: progressBarWidth }, 500).html(Math.floor(curentTime / 60) + ":" + curentTime % 60);
...
progress(beginningTime, endingTime, curentTime, $('#progressBar'));